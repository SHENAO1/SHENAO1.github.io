...
>    \cos^2(\pi f T_c)
>    =
>    \cos^2\left(\frac{2n+1}{2}\pi\right)
>    =
>    0
>    \qquad n\in\mathbb{Z}
>    $$
>
> 这说明分子中的码片窗口项确实会与分母同时趋零。下面再把“不会发散”的极限算出来。
>
> 令
>
> $$
...
> $$
>
> 则 $f\to f_0$ 等价于 $x\to x_0$，且
>
> $$
> \pi fT_c=M\pi fT_s=Mx
> $$
>
> 在这些点上，副载波分子项是有限且非零的：
>
...
> \frac{M\cos(Mx)}{-\sin x}
> =
> -M\frac{\cos(Mx_0)}{\sin x_0}
> $$
>
> 因为 $M$ 为偶数时 $\cos(Mx_0)=\pm1$，并且 $\sin x_0=\pm1$，所以
>
> $$
> L_e
> =
...
> \frac{-M\sin(Mx)}{-\sin x}
> =
> M\frac{\sin(Mx_0)}{\sin x_0}
> $$
>
> 因为 $M$ 为奇数时 $\sin(Mx_0)=\pm1$，并且 $\sin x_0=\pm1$，所以
>
> $$
> L_o
> =
...
> $$
>
> 因此，无论 $M$ 是奇数还是偶数，分母零点处的可去奇点极限都是有限的。若记
>
> $$
> f_0=(2r+1)f_s
> $$
>
> 则四个 BOC 功率谱公式在该点的统一极限为
>
> $$
> \lim_{f\to f_0}G(f)
> =
> \frac{M^2}{T_c(\pi f_0)^2}
> $$
>
